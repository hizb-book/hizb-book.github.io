...
const books = [
    ...
    {
        id:26,
        image: 'Way-of-thinking.png',
        name: 'WAY OF THINKING',
        author: '', 
        pages: 70,
        pdf: 'Way-of-thinking.pdf',
        indexPages: [1,2],
        language: 'English'
    },
    {
        id:27,
        image: 'WesternBeauty.png',
        name: 'The Western Beauty Myth',
        author: ' Shabaat of Hizb ut-Tahrir', 
        pages: 39,
        pdf: 'WesternBeauty.pdf',
        indexPages: [2],
        language: 'English'
    },
    {
        id:28,
        image: 'Way for revival.png',
        name: 'The Way For Revival',
        author: '',
        pages: 16,
        pdf: 'Way for revival.pdf',
        indexPages: [2],
        language: 'English'
    },
    ...
    books.forEach(book => {
        ...
        bookCard.innerHTML = `
            ...
            <div class="book-actions">
                <button onclick="downloadBook('book/${book.pdf}')"><i class="fas fa-download"></i> Download</button>
                <button onclick="viewIndex('book/${book.pdf}', ${indexPagesString})"><i class="fas fa-book-open"></i>  Index</button>
                <button onclick="copyLink('${book.id}')"><i class="fas fa-share-alt"></i>  Share</button>
            </div>
        `;
...
function copyLink(pdfLink) {
    // Create a temporary input element to hold the link
    const tempInput = document.createElement('input');
    tempInput.value = 'https://hizb-book.github.io/book.html?id='+pdfLink; // Set the value to the PDF link
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            notification.style.display = 'none'; // Hide after fading
...
document.getElementById('sort-options').addEventListener('change', function() {
    ...
    if (sortBy === 'name') {
        ...
        sortedBooks = books.sort((a, b) => a.id - b.id);
    }
